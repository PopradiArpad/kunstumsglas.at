...
const mkPropertyChanger = function(entity,pv,model,db){
  ...
  return new Changer(entity,property,valueAsString,model,db);
}

const getChangerConstructor = (propertyTypeName) => {
  switch (propertyTypeName) {
    case 'String':                    return StringChanger;
    case 'Boolean':                   return BoolChanger;
    case 'Buffer':                    return PicsChanger;
    case 'FileUploadStatus':          return FileChanger;
    case 'IdArray':                   return IdArrayChanger;
    case 'TranslatedStrings':         return TranslatedStringsChanger;
    case 'LocalizedStrings':          return LocalizedStringsChanger;
    default:
      throw new Error(`Cannot make property changer for ${propertyTypeName} property type`);
  }
}
